...
class Item(BaseModel):
    ...
    material = models.ForeignKey(Material, verbose_name =_("Material Type"), on_delete = models.CASCADE)
    ...
    measurement_units = models.ForeignKey(Measurement_units, on_delete = models.CASCADE)
