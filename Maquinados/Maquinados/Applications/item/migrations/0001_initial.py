    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='item.material', verbose_name='Material Type')),
                ('mesurement_units', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='item.measurement_uits')),
            ],
            options={
                'abstract': False,
            },
