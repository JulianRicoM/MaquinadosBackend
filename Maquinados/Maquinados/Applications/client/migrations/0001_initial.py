    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client.city')),
                ('country_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client.country')),
                ('departament_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client.department')),
            ],
            options={
                'abstract': False,
            },
